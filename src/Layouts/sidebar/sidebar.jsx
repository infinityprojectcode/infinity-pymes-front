    ...
    <div className="flex flex-col relative top-0 left-0 h-screen w-1/6 bg-100">
      <div className="flex flex-col h-full justify-start">
        <div className="flex flex-col justify-center text-center p-8">
          ...
          <h1 className="text-2xl font-base text-100 font-bold ">@User</h1>
        </div>
          ...
          {routes.map((item, index) => (
            <Link key={index} className="text-200" to={item.route}>
              <div className="p-4">
                <div
                  key={item.id}
                  className="w-full h-12 p-4 rounded-lg flex gap-10 flex-row justify-start items-center hover:bg-white hover:cursor-pointer hover:text-black font-semibold"
                >
      ...
      <div className="flex flex-col justify-end text-center p-8">
        <p className="text-200">&copy; 2026 Infinit Pymes</p>
      </div>
    </div>
  );
}
