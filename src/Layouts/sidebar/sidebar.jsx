                ...
                <div className='flex flex-col h-full gap-4'>
                    {routes.map((item, index) => (
                        <Link key={index} className='text-200' to={item.route}>
                            <div className='p-4'>
                                <div key={item.id} className='w-full h-12 p-4 rounded-lg flex gap-10 flex-row justify-start items-center hover:bg-white hover:cursor-pointer hover:text-black font-semibold'>
