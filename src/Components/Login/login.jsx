    ...
    return (
        <div className='flex h-screen w-full bg-gradient-to-r from-slate-700 relative overflow-hidden'>
            <div className='absolute inset-0 flex items-center justify-center w-full'>
                <img className='absolute inset-0 object-cover h-full w-full -z-10' src={ImagenFondo} alt='Background' />
            </div>
                    ...
                    <section className='pl-4 pr-4'>
                        ...
                        <form className='h-full'>
                            <div className='mb-4'>
                                ...
                                <input type='email' id='email' className='bg-gray-50 border border-gray-300 text-gray-900 text-sm outline-none rounded-full focus:ring-blue-500 focus:border-blue-500 block w-full pl-4 p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500' placeholder='username' required />
                            </div>
                            <div className='mb-6'>
