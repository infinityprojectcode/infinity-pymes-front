  ...
  return (
    <div className="flex flex-col">
      <div className="flex justify-between items-start">
        ...
        <button className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold p-2 rounded-lg transition duration-300">
          <svg
      ...
      <div className="w-full overflow-x-auto rounded-lg border border-gray-700  bg-gray-900 text-white p-3">
        ...
        {listProduct.map((item) => {
          ...
          >
            ...
            <div>${item.price}</div>
            <div>{item.stock}</div>
            <div className={`${auxiliar.color} w-fit px-2 text-white text-center font-semibold rounded-lg`}>{auxiliar.name}</div>
